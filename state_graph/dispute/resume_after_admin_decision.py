"""
state_graph/dispute/resume_after_admin_decision.py -- resumes the
dispute graph after a pending credit_approval task has been resolved via
scripts/resolve_admin_task.py.
...
if __name__ == "__main__":
    ...
    print("MCP write result:", final.get("mcp_write_result"))