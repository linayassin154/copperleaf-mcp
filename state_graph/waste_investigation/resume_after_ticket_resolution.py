"""
state_graph/waste_investigation/resume_after_ticket_resolution.py --
resumes the waste-investigation graph after a pending ticket has been
resolved via scripts/resolve_ticket.py.
...
if __name__ == "__main__":
    ...
    print("Ticket reason:", final.get("ticket_reason"))