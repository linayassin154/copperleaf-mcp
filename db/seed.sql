...
INSERT INTO staff (staff_id, branch_id, full_name, email, role, active, api_token) VALUES
    ...
    (5, 1, 'Hana Zaki',     'hana.zaki@copperleaf.com',     'staff',   0, 'FAKE_NOT_REAL_TOKEN_hana_005');
...
INSERT INTO inventory_items (
    item_id, branch_id, supplier_id, name, category, unit,
    current_quantity, reorder_threshold, unit_cost
) VALUES
    (1, 1, 1, 'Roma Tomatoes',   'produce',   'kg',   4.5, 10.0, 1.20),
    (2, 1, 1, 'Yellow Onions',   'produce',   'kg',  22.0, 8.0,  0.60),
    (3, 1, 2, 'Whole Milk',      'dairy',     'l',   15.0, 12.0, 0.95),
    (4, 1, 3, 'Chicken Breast',  'protein',   'kg',   9.0, 15.0, 3.40),
    (5, 1, 1, 'Basmati Rice',    'dry_goods', 'kg',  40.0, 10.0, 0.85),
    (6, 2, 3, 'Salmon Fillet',   'protein',   'kg',   6.0, 5.0,  8.75),
    (7, 2, 2, 'Feta Cheese',     'dairy',     'kg',   3.0, 4.0,  4.10),
...
INSERT INTO inventory_transactions (
    item_id, staff_id, change_type, quantity_change, reason, created_at
) VALUES
...
INSERT INTO supplier_orders (
    branch_id, supplier_id, item_id, quantity, status, ordered_at, expected_delivery
) VALUES
    ...
    (2, 1, 8, 20.0, 'cancelled', '2026-07-15 08:00:00', '2026-07-17');
